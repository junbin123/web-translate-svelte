...
var content = (function () {
    ...
    const file$1 = "src/components/Basics/Toast.svelte";
    ...
    function create_each_block(key_1, ctx) {
    	...
    	const block = {
    		...
    		c: function create() {
    			...
    			add_location(div, file$1, 35, 4, 721);
    			this.first = div;
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$1, 33, 0, 651);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_if_block(ctx) {
    	...
    	function formselect0_value_binding(value) {
    		/*formselect0_value_binding*/ ctx[19](value);
    	}

    	function formselect0_showList_binding(value) {
    		/*formselect0_showList_binding*/ ctx[21](value);
    	}

    	let formselect0_props = { options: /*langList*/ ctx[9] };
    	...
    	/*formselect0_binding*/ ctx[20](formselect0);
    	binding_callbacks.push(() => bind(formselect0, "showList", formselect0_showList_binding));
    	formselect0.$on("handleClick", /*handleLeftClick*/ ctx[15]);
    	formselect0.$on("handleChange", /*handleSelectChange*/ ctx[17]);

    	function formselect1_value_binding(value) {
    		/*formselect1_value_binding*/ ctx[22](value);
    	}

    	function formselect1_showList_binding(value) {
    		/*formselect1_showList_binding*/ ctx[24](value);
    	}

    	let formselect1_props = { options: /*langList*/ ctx[9] };
    	...
    	/*formselect1_binding*/ ctx[23](formselect1);
    	binding_callbacks.push(() => bind(formselect1, "showList", formselect1_showList_binding));
    	formselect1.$on("handleClick", /*handleRightClick*/ ctx[16]);
    	formselect1.$on("handleChange", /*handleSelectChange*/ ctx[17]);
    	...
    	const block = {
    		c: function create() {
    			...
    			t18 = space();
    			span5 = element("span");
    			span5.textContent = `${transServiceDict[/*transService*/ ctx[10]].name}`;
    			t20 = space();
    			div9 = element("div");
    			span6 = element("span");
    			t21 = space();
    			...
    			add_location(i0, file, 101, 10, 2469);
    			attr_dev(span0, "class", "trans-bar-left-name svelte-pi59sf");
    			add_location(span0, file, 102, 10, 2528);
    			attr_dev(i1, "class", "iconfont icon-arrow-right");
    			add_location(i1, file, 103, 10, 2582);
    			attr_dev(div0, "class", "trans-bar-left flex-between hover-color-orange svelte-pi59sf");
    			add_location(div0, file, 100, 8, 2398);
    			attr_dev(div1, "id", "trans-bar-middle");
    			attr_dev(div1, "class", "svelte-pi59sf");
    			add_location(div1, file, 105, 8, 2645);
    			attr_dev(span1, "class", "iconfont icon-push-pin padding-lr-8 hover-color-orange svelte-pi59sf");
    			toggle_class(span1, "icon-push-is-pin", /*isPin*/ ctx[6]);
    			add_location(span1, file, 107, 10, 2728);
    			attr_dev(span2, "class", "iconfont icon-close hover-color-orange svelte-pi59sf");
    			add_location(span2, file, 108, 10, 2867);
    			attr_dev(div2, "class", "trans-bar-right flex");
    			add_location(div2, file, 106, 8, 2683);
    			attr_dev(div3, "class", "trans-bar font-size-12 color-main flex-between padding-lr-16 svelte-pi59sf");
    			add_location(div3, file, 99, 6, 2315);
    			attr_dev(i2, "class", "trans-lang-middle iconfont icon-arrow-compare flex-center hover-color-orange");
    			add_location(i2, file, 120, 8, 3296);
    			attr_dev(div4, "class", "trans-lang flex-between padding-lr-16 svelte-pi59sf");
    			add_location(div4, file, 111, 6, 2980);
    			attr_dev(span3, "class", "color-99 font-size-10 leading-8");
    			add_location(span3, file, 131, 8, 3714);
    			attr_dev(div5, "class", "font-size-14 color-33");
    			add_location(div5, file, 132, 8, 3778);
    			attr_dev(div6, "class", "padding-lr-16 padding-tb-8");
    			add_location(div6, file, 130, 6, 3665);
    			attr_dev(span4, "class", "color-99 font-size-10 leading-8");
    			add_location(span4, file, 135, 8, 3900);
    			attr_dev(div7, "class", "font-size-14");
    			add_location(div7, file, 136, 8, 3964);
    			if (img.src !== (img_src_value = transServiceDict[/*transService*/ ctx[10]].src)) attr_dev(img, "src", img_src_value);
    			attr_dev(img, "width", "16");
    			attr_dev(img, "height", "16");
    			attr_dev(img, "alt", /*transService*/ ctx[10]);
    			add_location(img, file, 139, 12, 4160);
    			add_location(span5, file, 140, 12, 4263);
    			attr_dev(div8, "class", "font-size-12 color-66 transition-300 flex");
    			add_location(div8, file, 138, 10, 4067);
    			attr_dev(span6, "class", "iconfont icon-copy padding-lr-8 hover-color-orange");
    			add_location(span6, file, 143, 12, 4359);
    			attr_dev(span7, "class", "iconfont icon-open-web hover-color-orange");
    			add_location(span7, file, 144, 12, 4461);
    			add_location(div9, file, 142, 10, 4341);
    			attr_dev(div10, "class", "trans-footer flex-between svelte-pi59sf");
    			add_location(div10, file, 137, 8, 4017);
    			attr_dev(div11, "class", "trans-target padding-lr-16 svelte-pi59sf");
    			add_location(div11, file, 134, 6, 3851);
    			attr_dev(div12, "id", "trans-box");
    			attr_dev(div12, "class", "select-trans-pop color-main svelte-pi59sf");
    			attr_dev(div12, "style", div12_style_value = queryStringify(/*boxStyle*/ ctx[8]));
    			attr_dev(div12, "draggable", "true");
    			toggle_class(div12, "select-trans-pop-pin", /*isPin*/ ctx[6]);
    			add_location(div12, file, 91, 4, 2100);
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					listen_dev(span1, "click", /*handlePinClick*/ ctx[13], false, false, false),
    					listen_dev(span2, "click", /*handleClose*/ ctx[14], false, false, false),
    					...
    					listen_dev(div12, "click", /*handleBoxClick*/ ctx[18], false, false, false)
    				];
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (!current || dirty & /*boxStyle*/ 256 && div12_style_value !== (div12_style_value = queryStringify(/*boxStyle*/ ctx[8]))) {
    		...
    		d: function destroy(detaching) {
    			...
    			/*formselect0_binding*/ ctx[20](null);
    			destroy_component(formselect0);
    			/*formselect1_binding*/ ctx[23](null);
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(main, file, 88, 0, 2062);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ("boxLeft" in $$props) boxLeft = $$props.boxLeft;
    		if ("boxTop" in $$props) boxTop = $$props.boxTop;
    	};
