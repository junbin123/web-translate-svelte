...
var index = (function () {
    ...
    const file$5 = "src/components/Basics/Toast.svelte";
    ...
    function create_each_block$1(key_1, ctx) {
    	...
    	const block = {
    		...
    		c: function create() {
    			...
    			add_location(div, file$5, 35, 4, 721);
    			this.first = div;
    		},
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$5, 33, 0, 651);
    		},
    ...
    const file$4 = "src/components/Basics/TransTextarea.svelte";
    ...
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(span, file$4, 132, 8, 3823);
    			attr_dev(div, "class", "source-icon svelte-f6ggf5");
    			add_location(div, file$4, 131, 6, 3789);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, span);
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			span = element("span");
    			span.textContent = "...";
    			add_location(span, file$4, 143, 8, 4127);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img, file$4, 152, 8, 4417);
    			add_location(span0, file$4, 159, 8, 4597);
    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$3, 53, 6, 1252);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, t0);
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div2, file$3, 48, 2, 1082);
    ...
    const file$2 = "src/components/Basics/LangSelect.svelte";
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(i, file$2, 63, 2, 1368);
    			attr_dev(main, "class", "flex-between cursor-pointer svelte-zzcypp");
    			add_location(main, file$2, 55, 0, 1128);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    class LangSelect extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$2, create_fragment$2, safe_not_equal, { langList: 1, value: 0 });
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$1, 85, 8, 2112);
    			attr_dev(div1, "id", "trans-bar-middle");
    			attr_dev(div1, "class", "svelte-1je1rlz");
    			add_location(div1, file$1, 86, 8, 2183);
    			...
    			add_location(div6, file$1, 76, 4, 1796);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(main, file$1, 74, 0, 1770);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    class TranslatePop extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$1, create_fragment$1, safe_not_equal, { isShow: 0, sourceText: 1, boxStyle: 2 });
    ...
    function create_fragment(ctx) {
    	...
    	let translatepop;
    	let current;
    	translatepop = new TranslatePop({ $$inline: true });

    	const block = {
    		c: function create() {
    			main = element("main");
    			create_component(translatepop.$$.fragment);
    		...
    		m: function mount(target, anchor) {
    			insert_dev(target, main, anchor);
    			mount_component(translatepop, main, null);
    			current = true;
    		},
    		p: noop,
    		i: function intro(local) {
    			if (current) return;
    			transition_in(translatepop.$$.fragment, local);
    			current = true;
    		},
    		o: function outro(local) {
    			transition_out(translatepop.$$.fragment, local);
    			current = false;
    		},
    		d: function destroy(detaching) {
    			if (detaching) detach_dev(main);
    			destroy_component(translatepop);
    		}
    	};
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ TranslatePop });
    	return [];
    }
