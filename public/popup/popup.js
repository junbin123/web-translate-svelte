    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(i0, file$1, 155, 10, 3842);
    			attr_dev(span0, "class", "trans-bar-left-name svelte-e8cfs7");
    			add_location(span0, file$1, 156, 10, 3901);
    			attr_dev(i1, "class", "iconfont icon-arrow-right");
    			add_location(i1, file$1, 157, 10, 3955);
    			attr_dev(div0, "class", "trans-bar-left flex-between hover-color-orange svelte-e8cfs7");
    			add_location(div0, file$1, 154, 8, 3771);
    			attr_dev(div1, "id", "trans-bar-middle");
    			attr_dev(div1, "class", "svelte-e8cfs7");
    			add_location(div1, file$1, 159, 8, 4018);
    			attr_dev(span1, "class", "iconfont icon-push-pin padding-lr-8 hover-color-orange svelte-e8cfs7");
    			toggle_class(span1, "icon-push-is-pin", /*isPin*/ ctx[6]);
    			add_location(span1, file$1, 161, 10, 4101);
    			attr_dev(span2, "class", "iconfont icon-close hover-color-orange svelte-e8cfs7");
    			add_location(span2, file$1, 162, 10, 4240);
    			attr_dev(div2, "class", "trans-bar-right flex");
    			add_location(div2, file$1, 160, 8, 4056);
    			attr_dev(div3, "class", "trans-bar font-size-12 color-main flex-between padding-lr-16 svelte-e8cfs7");
    			add_location(div3, file$1, 153, 6, 3688);
    			attr_dev(i2, "class", "trans-lang-middle iconfont icon-arrow-compare flex-center hover-color-orange");
    			add_location(i2, file$1, 174, 8, 4669);
    			attr_dev(div4, "class", "trans-lang flex-between padding-lr-16 svelte-e8cfs7");
    			add_location(div4, file$1, 165, 6, 4353);
    			attr_dev(span3, "class", "color-99 font-size-10 leading-8");
    			add_location(span3, file$1, 185, 8, 5087);
    			attr_dev(div5, "class", "font-size-14 color-33");
    			add_location(div5, file$1, 186, 8, 5151);
    			attr_dev(div6, "class", "padding-lr-16 padding-tb-8");
    			add_location(div6, file$1, 184, 6, 5038);
    			attr_dev(span4, "class", "color-99 font-size-10 leading-8");
    			add_location(span4, file$1, 189, 8, 5273);
    			attr_dev(div7, "class", "font-size-14");
    			add_location(div7, file$1, 190, 8, 5337);
    			...
    			add_location(img, file$1, 193, 12, 5533);
    			add_location(span5, file$1, 194, 12, 5631);
    			attr_dev(div8, "class", "font-size-12 color-66 transition-300 flex");
    			add_location(div8, file$1, 192, 10, 5440);
    			attr_dev(span6, "class", "iconfont icon-copy padding-lr-8 hover-color-orange");
    			add_location(span6, file$1, 197, 12, 5722);
    			attr_dev(span7, "class", "iconfont icon-open-web hover-color-orange");
    			add_location(span7, file$1, 198, 12, 5824);
    			add_location(div9, file$1, 196, 10, 5704);
    			attr_dev(div10, "class", "trans-footer flex-between svelte-e8cfs7");
    			add_location(div10, file$1, 191, 8, 5390);
    			attr_dev(div11, "class", "trans-target padding-lr-16 svelte-e8cfs7");
    			add_location(div11, file$1, 188, 6, 5224);
    			attr_dev(div12, "id", "trans-box");
    			attr_dev(div12, "class", "select-trans-pop color-main svelte-e8cfs7");
    			attr_dev(div12, "style", queryStringify(/*boxStyle*/ ctx[13]));
    			attr_dev(div12, "draggable", "true");
    			toggle_class(div12, "select-trans-pop-pin", /*isPin*/ ctx[6]);
    			add_location(div12, file$1, 145, 4, 3473);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(main, file$1, 142, 0, 3435);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
